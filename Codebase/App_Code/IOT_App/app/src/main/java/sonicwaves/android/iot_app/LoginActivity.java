...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuth = app.getFirebaseUtils(getApplicationContext()).getmAuth();
    ...
    protected void onStart() {
        ...
        // if a current user is signed in then go to the scanner activity
        if (currentUser != null) {
            showProgress(true);
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCanceledListener(LoginActivity.this, new OnCanceledListener() {
                        ...
                        public void onCanceled() {
                            showProgress(false); //oncancelled
                        }
                    })
